  ...
  return (
    <section className="chat col-md-12 col-lg-5 col-xl-4">
      <div className="card chat__container" id="chat1">
        <div className="chat__card card-header d-flex justify-content-between align-items-center p-3 text-white border-bottom-0">
          <p className="mb-0 fw-bold">Room 1</p>
        </div>
        <div className="card-body">
          ...
          <div className="d-flex flex-row justify-content-end mb-4">
            <div className="p-3 me-3 border chat__my-msg">
              <p className="small mb-0">Thank you, I really like to be here.</p>
            </div>
            <img
              className="chat__img"
